...
* **Employee Dashboard**: Staff portal where employees can track visits scheduled for them, view general/walk-in arrivals, and pre-register guests.
* **Authentication & Role Management**: Secure user signup, login, and role-based access control (Admin, Security, Employee).
